...
\begin{itemize}
	...
	\begin{enumerate}
		...
		\item Les mots de passe ne sont pas géré automatiquement par le WAB, mais par des administrateurs, ce qui est totalement à l'opposé du but de l'utilisation d'une solution de PAM.
	\end{enumerate}
	\item Le vol d'une session d'un utilisateur, s'il part par exemple en pause et oublie de bloquer sa session. Mais cette faille est une faille humaine à laquelle on ne peut pallie uniquement en sensibilisant le personnel.
\end{itemize}
